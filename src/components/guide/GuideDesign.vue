            ...
            <div class="item" v-for="(item, index) in detail" :key="index">
               ...
               <ul>
                   <li v-for="(childItem, childIndex) in item.children" :key="childIndex">
                       <strong>{{childItem.description}}</strong>
                       {{childItem.content}}
                   </li>
               </ul>    
            </div>    
            ...
            detail: [
                {
                    ...
                    children: [
                        ...
                        {
                            description: '在界面中一致：',
                            content: '所有的元素和结构需保持一致，比如：设计样式、图标和文本、元素的位置等。'
                        }
                    ]
                },
                {
                ...
                },
                {
                    ...
                    children: [
                        {
                            description: '用户决策：',
                            content: '根据场景可给予用户操作建议或安全提示，但不能代替用户进行决策；'
                        },
                        {
                            description: '结果可控：',
